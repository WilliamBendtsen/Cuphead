    ...
    return (
        <div className="lg:relative sm:flex sm:flex-col justify-center items-center">
            <Image
             ...
             sm:text-2xl xl:text-4xl lg:text-2xl text-white sm:bg-none lg:bg-slate-950 bg-opacity-30 lg:bg-opacity-30 p-5 text-whitep-5 rounded-3xl top-50 left-12">Baroness Von Bon Bon is the eccentric candy queen of Sugarland in the Cuphead-verse, 
