    ...
    return (
        <div className="lg:relative sm:flex sm:flex-col justify-center items-center">
            <Image
             ...
             />
             <p className="lg:absolute mg:relative w-11/12 sm:w-3/4 lg:w-1/2 text-lg sm:text-2xl xl:text-4xl lg:text-2xl text-white sm:bg-none lg:bg-green-950 lg:bg-opacity-30 p-5 rounded-3xl top-50 lg:top-auto lg:right-12">Cuphead and Mugman are two adventurous brothers from
